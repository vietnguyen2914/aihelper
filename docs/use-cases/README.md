...
- One-line launcher: `~/github/aihelper/bin/aihelper "your prompt"`
- Direct engine call: `python3 ~/github/aihelper/context_engine/main.py analyze "your prompt" --project-root "$PWD"`
