...
```bash
/Users/vietnguyen/github/aihelper/bin/aihelper "build project KB"
```

### Explicit target root

```bash
AIHELPER_TARGET_ROOT=/opt/homebrew/var/www/his /Users/vietnguyen/github/aihelper/bin/aihelper "build project KB"
```
