...
```bash
AIHELPER_TARGET_ROOT=/Users/vietnguyen/github/mindforme /Users/vietnguyen/github/aihelper/bin/aihelper "trace S3 upload flow"
```

### Prompt-only output

```bash
/Users/vietnguyen/github/aihelper/bin/aihelper analyze "trace S3 upload flow" --format prompt
```
