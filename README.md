...
/Users/vietnguyen/github/aihelper/bin/aihelper cache build --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper cache status --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper cache watch --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper cache watch-all --extra-project /opt/homebrew/var/www/his
/Users/vietnguyen/github/aihelper/bin/aihelper cache warm --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper prompt-blocks build --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper diff-summary --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper memory recall --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper symbol find UserService --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper symbol context UserService --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper deps UserService --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper route "fix checkout service" --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper patch-plan "fix checkout service" --file src/path/File.java
/Users/vietnguyen/github/aihelper/bin/aihelper patch-apply --patch-file /tmp/change.diff --project-root "$PWD"
/Users/vietnguyen/github/aihelper/bin/aihelper validate-files src/path/File.java --project-root "$PWD"
...
`aihelper cache watch-all` discovers each Git repository under `/Users/vietnguyen/github` as a separate project root and can add external projects such as `/opt/homebrew/var/www/his`. `cache warm` builds cache plus precompiled prompt blocks.
